...
const FinancialsTable = () => {
  ...
  const [selectedTab, setSelectedTab] = useState("Balance Sheet"); // Initialize the selected tab
  const [displayAnnual, setDisplayAnnual] = useState(true); // Initialize display mode as annual
